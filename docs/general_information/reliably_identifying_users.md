[API v0.6](info.md) includes the numeric user ID ```uid``` of the account in addition to the display name (the previous API v0.5 returned only the user display name(1)).
{ .annotate }
