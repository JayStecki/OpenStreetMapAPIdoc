...
!!! warning "To delete an existing way, you must **first** operate inside [open changeset](open_changeset.md)."
...
In `request body` the ==way ID== and ==version== are also required (check the example).
