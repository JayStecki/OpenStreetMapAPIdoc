The documentation was created in a controlled cooperation between a human (NI) and a machine (AI), but **not** for the creation of any documentation content (or its parts) :sunglasses:.
